...
class CredentialItemWidget(QFrame):
    ...
    def _init_ui(self):
        ...
        copy_user_btn.clicked.connect(
            lambda: self.copy_username.emit(self.credential.id)
        )
        ...
        copy_pwd_btn.clicked.connect(
            lambda: self.copy_password.emit(self.credential.id)
        )
...
class VaultWidget(QWidget):
    ...
    def _init_ui(self):
        ...
        self.empty_label.setStyleSheet(
            "color: #a0a0a0; font-size: 14px; padding: 40px;"
        )
